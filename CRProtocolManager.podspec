...
Pod::Spec.new do |s|
  ...
  s.description  = Componentization iOS

  s.homepage     = "https://github.com/MYE-iOS/CRProtocolManager"
  ...
  s.source       = { :git => "https://github.com/MYE-iOS/CRProtocolManager.git", :tag => s.version }
